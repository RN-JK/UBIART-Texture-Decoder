...
for ckdtextures in os.listdir(wiidir):
    ...
    cmpr.write(b'\x00\x20\xAF\x30\x00\x00\x00\x01\x00\x00\x00\x0C\x00\x00\x00\x20\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'+struct.pack('>H',height)+struct.pack('>H',width)+b'\x00\x00\x00\x0E\x00\x00\x00\x60\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
    cmpr.write(data)
    cmpr.close()
